...
export function MyListings({ onEditProduct }: MyListingsProps) {
  const [listings, setListings] = useState<Listing[]>([
    ...
    },
    {
      ...
      category: 'home',
      condition: 'Like New',
      image: 'https://images.unsplash.com/photo-1589365354848-78104c17f92d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdXN0YWluYWJsZSUyMHByb2R1Y3RzJTIwZWNvJTIwZnJpZW5kbHl8ZW58MXx8fHwxNzU3MTM1Mzk5fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
      status: 'sold',
      views: 120,
      likes: 15,
      messages: 8,
